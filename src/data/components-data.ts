...
export function AIReasoningStream({
  ...
  return (
    <div className="w-full max-w-[460px] flex flex-col font-sans select-none">
...
export function StackedTaskCard({
  ...
  return (
    <div className="relative w-full max-w-[420px] select-none font-sans pt-3 pb-6">
      {/* 1. Main Front Card */}
      <div className="relative z-10 w-full rounded-[30px] bg-white dark:bg-[#161718] border border-black/[0.06] dark:border-[#23252a] p-6 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] transition-all">
