...
export function ShareModalDialog({
  ...
  return (
    <div className="relative w-full max-w-[310px] rounded-[26px] bg-white dark:bg-[#161718] border border-black/[0.06] dark:border-[#23252a] shadow-[0_16px_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.6)] pt-7 pb-4 px-4.5 select-none font-sans">
  ...
  {
    id: "comp-23",
    slug: "ai-reasoning-stream",
    title: "AI Reasoning Thought Stream",
    description: "Interactive AI reasoning and execution trace stream featuring progressive dot matrix density icons, embedded resource thumbnail badges, live countdown timers, and a floating prompt bar adapted for Weblocks.",
    category: "inputs",
    tier: "free",
    cliCommand: "npx weblocks add ai-reasoning-stream",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    tags: ["inputs", "forms", "ai", "reasoning", "stream", "prompt", "chat", "timeline"],
    props: [
      { name: "placeholder", type: "string", default: '"Ask anything..."', description: "Placeholder string in floating prompt bar" },
      { name: "statusText", type: "string", default: '"Noodling..."', description: "Label for the in-progress stream step" },
      { name: "onSend", type: "(prompt: string) => void", description: "Callback triggered when user submits a query" },
      { name: "onAddAttachment", type: "() => void", description: "Callback when clicking the + button" },
    ],
    code: `"use client";
...
export function AIReasoningStream({
  ...
  return (
    <div className="w-full max-w-[370px] flex flex-col font-sans select-none">
      ...
      <div className="flex flex-col gap-2.5 mb-4">
        ...
        <div className="flex items-center justify-between gap-2.5 text-[12.5px] text-[#111827] dark:text-[#f3f4f6]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex items-center gap-1.5 truncate">
              ...
              <span className="truncate">Cosmos, Pinterest, & more</span>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between gap-2.5 text-[12.5px] text-[#111827] dark:text-[#f3f4f6]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex items-center gap-1.5 truncate">
              ...
              <span className="truncate">wishlists</span>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between gap-2.5 text-[12.5px] text-[#111827] dark:text-[#f3f4f6]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex items-center gap-1.5 truncate">
              ...
              <span className="truncate">your aesthetic</span>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between gap-2.5 text-[12.5px] text-[#111827] dark:text-[#f3f4f6]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex items-center gap-1.5 truncate">
              ...
              <span className="truncate">Outerwear options</span>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between gap-2.5 text-[12.5px] text-[#111827] dark:text-[#f3f4f6]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="truncate">Filtering finds by price, size, & relevance &gt;</span>
          </div>
        ...
        <div className="flex items-center justify-between gap-2.5 text-[12.5px] text-[#111827] dark:text-[#f3f4f6]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex items-center gap-1.5 truncate">
              ...
              <span className="truncate">Chore jackets</span>
            </div>
          </div>
  ...
  {
    id: "comp-24",
    slug: "stacked-task-card",
    title: "Stacked Task Card",
    description: "Physical card deck stack for urgent tasks and notifications, featuring layered perspective cards, top floating action pills, and 1-click completion and snoozing adapted for Weblocks.",
    category: "cards",
    tier: "free",
    cliCommand: "npx weblocks add stacked-task-card",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    tags: ["cards", "bento", "tasks", "notifications", "toast", "stacked", "deck", "actions"],
    props: [
      { name: "title", type: "string", default: '"Send notes to Johnny"', description: "Primary task headline" },
      { name: "meta", type: "string", default: '"New Task • Assigned to You 3m ago"', description: "Metadata category and assignment timestamp" },
      { name: "totalInQueue", type: "number", default: 3, description: "Number of stacked cards remaining in deck" },
      { name: "onDone", type: "() => void", description: "Callback triggered when task is completed" },
      { name: "onRemindLater", type: "() => void", description: "Callback triggered when snoozed" },
      { name: "onDismiss", type: "() => void", description: "Callback triggered when close button is clicked" },
    ],
    code: `"use client";

import React, { useState } from "react";
import { MoreHorizontal, X, Bell, CheckCircle2 } from "lucide-react";

export interface StackedTaskCardProps {
  title?: string;
  meta?: string;
  totalInQueue?: number;
  onDone?: () => void;
...
export function StackedTaskCard({
  title = "Send notes to Johnny",
  meta = "New Task • Assigned to You 3m ago",
  totalInQueue = 3,
  onDone,
  onRemindLater,
  onDismiss,
}: StackedTaskCardProps) {
  ...
  return (
    <div className="relative w-full max-w-[340px] sm:max-w-[360px] select-none font-sans pt-2 pb-5">
      {/* 1. Main Front Card */}
      <div className="relative z-10 w-full rounded-[24px] bg-white dark:bg-[#161718] border border-black/[0.06] dark:border-[#23252a] p-4 sm:p-5 shadow-[0_16px_40px_-10px_rgba(0,0,0,0.08)] dark:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.5)] transition-all">
